...
**Current version:** `0.0.33` — check the bottom of the left sidebar for the
...
- Google Maps overview with standalone itinerary pins, transportation-only route segments, photos, and item details
